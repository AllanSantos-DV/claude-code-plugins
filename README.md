...
| --- | --- | --- |
| [**claude-code-boss**](./claude-code-boss) | 2.19.0 | Brain KB (busca semântica local), execução curada anti context-bloat e aprendizado in-loop. Opcionalmente conecta a um servidor **MCP Memory** externo. |
